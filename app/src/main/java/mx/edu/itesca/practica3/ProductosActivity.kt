...
class ProductosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imagencita = findViewById(R.id.imageView)
        var menuOption: String? = intent.getStringExtra("menuType")
        agregarProductos(menuOption)

        var listview: ListView = findViewById(R.id.lisview)
    ...
    fun agregarProductos(option: String?) {
        when (option) {
            "Antojitos" -> {
                imagencita.setImageResource(R.drawable.antojitos)
                menu.add(
                    Product(
                        "Quesadillas",
                        R.drawable.quesadillas,
                        "Rellenas con su carne favorita, servidas con ensalada. Filled with ypur choice of meat, served with salad.",
                        5.69
                    )
                )
                menu.add(
            ...
            "Especialidades" -> {
                imagencita.setImageResource(R.drawable.especialidades)
                menu.add(
                    Product(
            ...
            "Combinations" -> {
                imagencita.setImageResource(R.drawable.combinations)
                menu.add(
                    Product(
            ...
            "Tortas" -> {
                imagencita.setImageResource(R.drawable.tortas)
                menu.add(
                    Product(
                        "Torta Regular",
                        R.drawable.torta,
            ...
            "Sopas" -> {
                imagencita.setImageResource(R.drawable.sopas)
                menu.add(
                    Product(
                        "Pozole",
                        R.drawable.pozole,
            ...
            "Drinks" -> {
                imagencita.setImageResource(R.drawable.drinks)
                menu.add(
                    Product(
                        "Soft Drinks 20oz - Sodas 20oz.",
